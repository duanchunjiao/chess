        ...
        <div class="col-sm-12">
            ...
            <c:choose>
	            <c:when test="${empty cartList}">
	                <h3 class="text-center">购书车空空如也 <a href="http://localhost:8080/bookstore/index.jsp">去购物</a></h3>
	            </c:when>
	            <c:otherwise>
                <div class="panel-body">
                    ...
                    <c:forEach items="${cartList}" var="cart" varStatus="status">
                        <tr>
                            ...
                            <td>${cart.number}</td>
                            <td width="15%">
                           <a href="deleteCart?bookId=${cart.book.bookId}">删除</a>
                            </td>
                    ...
                    <tr>
                   		 ...
                   		 <tr>
                            <td>用户：${currentUser.userName}</td>
                            <td>总价格：${totalPrice}</td>
                            <td></td>
                            <td></td>
                            <td>数量：${numbersum}</td>
                            <td>
                                <a href="sellteServlet?listchang=${listchang}">结账</a>
                            </td>
                        </tr>
                    </tbody>
                    </table>
