               ...
               <c:choose>
                ...
                <div class="panel-body">
                    ...
                    <c:forEach items="${userList}" var="list">
                        <tr>
                        <td><input type="checkbox" value="${list.userId }" name="checkbox"/></td>
                            <td>${list.userId}</td>
                            <td>${list.userLevelId}</td>
                            <td>${list.userName}</td>
                            <td>${list.userPassword}</td>
                            <td><a href="userdelectServlet?userId=${list.userId}">删除</a></td>
                        </tr>
                    </c:forEach>             
                    </tbody>
                    </table>
                    <div align="center"><button id="delAll">删除选中</button></div>
                </div>
                </c:otherwise>
             </c:choose>
            </div>
	...
	<script type="text/javascript">
		$(function(){
			...
			/*$(".del").click(function(){
				$.ajax({
					type:"post",
					url:"bookdelectServlet?bookid=${list.bookId}",
					data:{
						"bookId":$(this).val(),
					},
					success:function(){
			...
			$("#delAll").click(function(){
						...
						$("tbody input:checked").each(function(){
							$.ajax({
								type:"post",
								url:"${pageContext.request.contextPath}/admin/bookdelectServlet",
								data:{
									"bookId":$(this).val(),
								},
								success:function(){
